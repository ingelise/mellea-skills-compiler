---
name: mellea-fy-behaviours
description: '# Melleafy: Known Mellea Behaviours & Workarounds'
metadata:
  user-invocable: true
...
Version-conditional guidance (0.7 vs pre-0.7 imports, telemetry env vars, OTel attributes) lives in `.bob/data/compatibility.yaml` and is filtered by installed mellea version at grounding time — not inline here.
